...
class HotelController extends Controller
{
    ...
    public function getHotelImages($slug)
    {
        ...
        // image_urls accessor akan otomatis diappend
    ...
    public function show($slug)
    {
        ...
        // image_urls dan thumbnail sudah otomatis diappend dari model
    ...
    public function checkAvailability(Request $request, $hotelId)
    {
        ...
        return response()->json([
            'success' => true,
            'data' => [
                'hotel' => $hotel->only(['id', 'name', 'slug', 'image_urls', 'thumbnail']),
    ...
    public function quickAvailabilityCheck(Request $request)
    {
        $request->validate([
            ...
            'guests_per_room' => 'required|integer|min:1|max:10',
        ]);
    ...
    public function searchSuggestions(Request $request)
    {
        ...
        $hotels = Hotel::where('status', 'active')
            ...
            ->get()
            ->map(function ($hotel) {
                // Gunakan accessor image_urls yang sudah ada di model
                $imageUrls = $hotel->image_urls;
